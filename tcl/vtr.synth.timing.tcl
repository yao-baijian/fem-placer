# =============================================================================
# VTR Synthesis Script with Timing Constraints (out_of_context mode)
# =============================================================================
# Same as vtr.synth.tcl but with:
...
# Usage:
#   cd vivado
#   vivado -mode batch -source ../tcl/vtr.synth.timing.tcl
# =============================================================================
...
# mkDelayWorker32B D:/Project/fem-placer-latest/fem-placer/benchmarks/vtr/mkDelayWorker32B.v
...
foreach {top_module rtl_file} $benchmarks {
    ...
    # Try to find a clock port by common names, skip timing if none found
    set clk_ports [get_ports -quiet -filter {DIRECTION == IN && (NAME =~ "*clk*" || NAME =~ "*clock*" || NAME =~ "*CK*" || NAME =~ "*Clk*")}]
